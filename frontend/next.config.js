                ...
                headers: [
                    {
                        ...
                        value: [
                            ...
                            "font-src 'self' data:;",
                            "connect-src 'self' http://localhost:* http://127.0.0.1:* https://warm-ram-79.clerk.accounts.dev https://*.clerk.accounts.dev https://api.openai.com https://generativelanguage.googleapis.com https://api.litxplore.win ws://localhost:* ws://127.0.0.1:*;",
